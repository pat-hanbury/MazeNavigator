...
public:
	...
	void printPath(Graph::vertex_descriptor end,
		...
		Graph g);
	//function that finds path from start to goal using depth-first search
	void findPathDFSRecursive();

	int numRows() { return rows; };
	int numCols() { return cols; };
	matrix<Graph::vertex_descriptor> getVertexCoords() { return vertexCoords; };
